...
cont_names = ['temp', 'atemp', 'humidity', 'windspeed', 'casual', 'registered',
              'rent_count']
# Clean the data: Transform the categorical variables to something similar to pd.Categorical.
# Fill the missing values in continuous columns. Turn values into normal distribution.
procs = [Categorify, FillMissing, Normalize]
# Define splits
splits = RandomSplitter()(range_of(dfFirstCycle_train))
trainingFirstCycle = TabularPandas(dfFirstCycle_train, procs, cat_names,
